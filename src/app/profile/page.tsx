...
function ProfilePage() {
    ...
    const percentage = (level / totalModules) * 100
    ...
    async function getProfile() {
        try {
            ...
            setLevel(res.data.data.unlockedUpto)
        } catch (error: any) {
                ...
                <div className="bg-[#1f1b2c] rounded-[15px] p-4 border-[#2a263c] border-solid shadow-[0_10px_30px_rgba(0,0,0,0.4)] m-10">
                    ...
                    <div className="mt-4 ">
                        <div className="flex justify-between">
                            <p>Level 1</p>
                            <p>{level * 500} / 3,000 EXP</p>
                        </div>
                        <div className="h-5 mt-2 bg-[#3b335b] rounded-4xl">
                            <div className="bg-[#8a63c2] h-full rounded-4xl" style={{ width: `${percentage}%` }}></div>
                        </div>
                    </div>
                    ...
                    <div className="mt-2.5 rounded-xl">
                        ...
                        <div className="mt-2.5 rounded-xl">
                            ...
                            <button onClick={onLogout} className="rounded-xl mb-2.5 p-1 hover:bg-[#2a263c] flex justify-between w-full"><div className="flex items-center"><LogOut className="iconList" /><span className="profileOptions">Logout</span></div><ChevronRight /></button>
                        </div>
                    </div>
